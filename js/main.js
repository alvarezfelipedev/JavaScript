  ...
  agregarCasa(casa) {
    ...
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <input type="submit" value="Eliminar" class="btn btn-primary btn-block" name="eliminar" />
          <input type="submit" value="Favorito" class="btn btn-primary btn-block" name="favorito" />
      </div>
    </div>
        `;
